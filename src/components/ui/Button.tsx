...
// By using this we can apply the same styling to other components
// For example I am using this in Link component which will look like a button but actually a link
